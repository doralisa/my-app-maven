...
public class PostView {
    ...
    public String getNicknameToFind() {
        System.out.println("Ingrese el seudonimo del usuario autor del post ó presione Q|q para continuar : ");
    ...
    public String getDataPost() {
        System.out.println("Ingrese el contenido del post [ presione Q|q para cancelar ]: ");
        return Keyboard.getInputAlphanumeric();
    }
    ...
    public void showTitleEditOrDeletePost(String action) {
        ...
        System.out.println("\n######################################");
        System.out.println("# Ada Social Network: " + title + " Post #");
        System.out.println("######################################\n");
    }
    ...
    public void editOrDeletePostCanceled(String action) {
    ...
    public void errorWhenDeletingRecord() {
        System.out.println("\nOops!! hubo un error al eliminar el registro, intentelo de nuevo.\n");
    }
} // clase 29/01 12 min
